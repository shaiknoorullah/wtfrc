...
func setupCoachEnvironment(ctx context.Context) error {
	...
	seedCmds := []string{
		`sqlite3 ~/.local/share/wtfrc/kb.db "INSERT OR IGNORE INTO entries (tool, type, raw_binding, raw_action, description, source_file, source_line, category, see_also, indexed_at, file_hash) VALUES ('zsh', 'alias', 'gs', 'git status', 'git status alias', '/home/test/.zshrc', 4, 'shell', '[]', strftime('%Y-%m-%dT%H:%M:%SZ','now'), 'seed')"`,
		`sqlite3 ~/.local/share/wtfrc/kb.db "INSERT OR IGNORE INTO entries (tool, type, raw_binding, raw_action, description, source_file, source_line, category, see_also, indexed_at, file_hash) VALUES ('zsh', 'alias', 'll', 'ls -la', 'list files alias', '/home/test/.zshrc', 5, 'shell', '[]', strftime('%Y-%m-%dT%H:%M:%SZ','now'), 'seed')"`,
		`sqlite3 ~/.local/share/wtfrc/kb.db "INSERT OR IGNORE INTO entries (tool, type, raw_binding, raw_action, description, source_file, source_line, category, see_also, indexed_at, file_hash) VALUES ('zsh', 'alias', 'gp', 'git push', 'git push alias', '/home/test/.zshrc', 6, 'shell', '[]', strftime('%Y-%m-%dT%H:%M:%SZ','now'), 'seed')"`,
		`sqlite3 ~/.local/share/wtfrc/kb.db "INSERT OR IGNORE INTO entries (tool, type, raw_binding, raw_action, description, source_file, source_line, category, see_also, indexed_at, file_hash) VALUES ('zsh', 'alias', 'gd', 'git diff', 'git diff alias', '/home/test/.zshrc', 7, 'shell', '[]', strftime('%Y-%m-%dT%H:%M:%SZ','now'), 'seed')"`,
	}
